...
final class CommitViewController: NSViewController {
    ...
    override func loadView() {
        ...
        pushAfter.state = UserDefaults.standard.bool(forKey: "pairprogram.pushAfterCommit") ? .on : .off
    ...
    @objc private func commitClicked() {
        ...
        UserDefaults.standard.set(pushAfter.state == .on, forKey: "pairprogram.pushAfterCommit")
...
final class MergeViewController: NSViewController {
    ...
    override func loadView() {
        ...
        let saved = UserDefaults.standard.string(forKey: "pairprogram.mergeMethod").flatMap(GitHub.MergeMethod.init(rawValue:))
        ...
        deleteBranch.state = info.deleteBranchDefault || UserDefaults.standard.bool(forKey: "pairprogram.deleteBranchOnMerge") ? .on : .off
    ...
    @objc private func mergeClicked() {
        ...
        alert.beginSheetModal(for: window) { [weak self] response in
            ...
            MainActor.assumeIsolated {
                UserDefaults.standard.set(m.rawValue, forKey: "pairprogram.mergeMethod")
                UserDefaults.standard.set(delete, forKey: "pairprogram.deleteBranchOnMerge")
