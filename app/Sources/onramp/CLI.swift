...
enum CLI {
    ...
    static let bundleID = "com.timwheeler.onramp"
    static let openNotification = Notification.Name("com.timwheeler.onramp.open")
    ...
    static func prepareOpen(_ argv: [String]) -> Open {
        ...
        guard !wait, env["ONRAMP_DETACHED"] == nil, env["ONRAMP_SELFTEST"] == nil else { return .run(repo: root) }
